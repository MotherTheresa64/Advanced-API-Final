...
# ——— Monkey-patch for Flasgger + Python 3.13+ compatibility ———
# 1) Restore JSONEncoder alias
flask.json.JSONEncoder = DefaultJSONProvider

# 2) Stub out imp module for flasgger.utils
...
def create_app(config_object):
    ...
    def index():
        # health-check and redirect to Swagger UI
